...
run_options = {analysis_action: "start", without_delay: true, analysis_type: "batch_run", allow_multiple_jobs: true, use_server_as_worker: true, simulate_data_point_filename: "simulate_data_point_lhs.rb"}
api.run_analysis(analysis_id, run_options)
