      ...
      if space_type_lights.size > 0 and space_type_spaces.size > 0
        ...
        space_type_lights.each do |space_type_light|
          ...
          if not space_type_light.schedule.empty?
            space_light_new_schedule =  space_type_light.schedule
        ...
        space_light_new.setSpaceType(space_type)
        ...
        if cost_included
          ...
          if(retrofit == "Retrofit")
            ...
            retrofit_ccli = OpenStudio::Model::ComponentCostLineItem.new(space_light_new)
        ...
        if not space_light_new.schedule.empty? and multiple_schedules == true
          ...
          runner.registerWarning("The space type named '#{space_type.name.to_s}' had more than one light object with unique schedules. The schedule named '#{space_light_new_schedule.get.name.to_s}' was used for the new LPD light object.")
        end
