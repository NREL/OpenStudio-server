...
#start the measure
class TestTestMeasureHadaRubyError < OpenStudio::Ruleset::ModelUserScript
  
  #define the name that a user will see, this method may be deprecated as
  #the display name in PAT comes from the name field in measure.xml
  def name
    return "TestTestMeasureHadaRubyError"
  end
  ...
  def run(model, runner, user_arguments)
    ...
    user_name = runner.getStringArgumentValue("this shoudl say user_name",user_arguments)
...
TestTestMeasureHadaRubyError.new.registerWithApplication