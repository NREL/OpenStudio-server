#start the measure
class JusttheSampleReportingMeasureyougetwhenyoucreateanewreportingmeasure < OpenStudio::Ruleset::ReportingUserScript
  
  #define the name that a user will see, this method may be deprecated as
  #the display name in PAT comes from the name field in measure.xml
  def name
    return "JusttheSampleReportingMeasureyougetwhenyoucreateanewreportingmeasure"
  end
...
JusttheSampleReportingMeasureyougetwhenyoucreateanewreportingmeasure.new.registerWithApplication