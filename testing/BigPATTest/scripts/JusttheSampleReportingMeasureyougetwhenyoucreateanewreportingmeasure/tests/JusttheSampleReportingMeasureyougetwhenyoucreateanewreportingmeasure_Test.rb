...
class JusttheSampleReportingMeasureyougetwhenyoucreateanewreportingmeasure_Test < Test::Unit::TestCase
  ...
  # the actual test
  def test_JusttheSampleReportingMeasureyougetwhenyoucreateanewreportingmeasure
     
    assert(File.exist?(modelPath()))
    assert(File.exist?(sqlPath()))
     
    # create an instance of the measure
    measure = JusttheSampleReportingMeasureyougetwhenyoucreateanewreportingmeasure.new
