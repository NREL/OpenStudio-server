...
class EnableDemandControlledVentilation_Test < Test::Unit::TestCase

  def test_EnableDemandControlledVentilation_single_loop
  ...
  def test_EnableDemandControlledVentilation_all_loop
