...
ls /Users/travis/build/NREL/export

sudo mkdir /${OPENSTUDIO_VERSION}

sudo mv /Users/travis/build/NREL/export/${oss_filename}  /${OPENSTUDIO_VERSION}/
export ARTIFACTS_PATHS="/${OPENSTUDIO_VERSION}/${oss_filename}"
