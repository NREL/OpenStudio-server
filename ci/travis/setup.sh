...
if [ "${BUILD_TYPE}" == "docker" ]; then
    ...
    if [ "${TRAVIS_OS_NAME}" == "osx" ]; then
        ...
        curl -SLO --insecure https://openstudio-builds.s3.amazonaws.com/3.0.0/OpenStudio-3.0.0-rc1%2B7e86eb3b12-Darwin.dmg
        # OSX downloads with %2B. These are unsafe chars in url strings
        hdiutil attach OpenStudio-3.0.0-rc1%2B7e86eb3b12-Darwin.dmg
        ...
        sudo /Volumes/OpenStudio-3.0.0-rc1+7e86eb3b12-Darwin/OpenStudio-3.0.0-rc1+7e86eb3b12-Darwin.app/Contents/MacOS/OpenStudio-3.0.0-rc1+7e86eb3b12-Darwin --script ci/travis/install-mac.qs
        hdiutil detach /Volumes/OpenStudio-3.0.0-rc1+7e86eb3b12 -force
