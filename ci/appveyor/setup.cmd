...
curl -SLO --insecure https://openstudio-ci-builds.s3-us-west-2.amazonaws.com/develop/%OS_INSTALL_NAME%
REM curl -SLO --insecure  https://github.com/NREL/OpenStudio/releases/download/v3.5.1/%OS_INSTALL_NAME%
dir .
