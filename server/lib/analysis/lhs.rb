class Analysis::Lhs < Struct.new(:options)
  ...
  def perform
    ...
    selected_variables.each do |var|
      samples["#{i_var}"] = samples_from_probability(p[i_var], var.uncertainty_type, var.modes_value, nil, var.lower_bounds_value, var.upper_bounds_value)
    ...
    # The arrays of the hash need to always have the same length, so just use the first to iterate
    ...
    samples.each do |sample|
      ...
      dp_name = "LHS Autogenerated #{sample.flatten.join("_")}"
