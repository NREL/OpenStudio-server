...
begin
  ...
  FileUtils.copy("/mnt/openstudio/run_openstudio_xml.rb", "#{directory}/run_openstudio_xml.rb")
  ...
  command = "ruby -I/usr/local/lib/ruby/site_ruby/2.0.0/:#{File.dirname(__FILE__)} #{directory}/run_openstudio_xml.rb -u #{options[:uuid]} -d #{directory} -r AWS "
