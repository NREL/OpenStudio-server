...
docker pull nrel/openstudio-server:3.6.1-3
docker pull nrel/openstudio-rserve:3.6.1-3
...
sleep 10
echo "tag"
docker tag nrel/openstudio-server:3.6.1-3 127.0.0.1:5000/openstudio-server
docker tag nrel/openstudio-rserve:3.6.1-3 127.0.0.1:5000/openstudio-rserve
