...
echo "rm -rf /data/dbdata/*"
rm -rf /data/dbdata/*

echo "pull images"
docker pull registry:2.6
docker pull nrel/openstudio-server:3.10.0-pandas
...
sleep 10
echo "tag"
docker tag nrel/openstudio-server:3.10.0-pandas 127.0.0.1:5000/openstudio-server
