...
docker swarm init
docker service create --name registry --publish 5000:5000 --mount type=volume,source=regdata,destination=//c//Projects//OS-Server-UrbanOpt//local_setup_scripts registry:2.6
sleep 10
echo "tag"
