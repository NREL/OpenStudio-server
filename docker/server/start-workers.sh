...
#/opt/openstudio/server/bin/aws_imdsv2_testing >> /opt/openstudio/server/log/aws_imds.log 2>&1 &
#/opt/openstudio/server/bin/aws_imdsv2_polling >> /opt/openstudio/server/log/aws_imds.log 2>&1 &
/opt/openstudio/server/bin/aws_imdsv2_mock >> /opt/openstudio/server/log/aws_imds.log 2>&1 &
