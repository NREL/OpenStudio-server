...
%Q{
  ...
  for(i in 1:nrow(ips)) {b[i] = ips[i,]}
     ...
     f <- function(x){ 
       ...
       dbDisconnect(mongo)
       y <- paste("/usr/local/rbenv/shims/ruby -I/usr/local/lib/ruby/site_ruby/2.0.0/ /home/vagrant/SimulateDataPoint.rb -d /home/vagrant/analysis/data_point_",x," -r Vagrant",sep="")
